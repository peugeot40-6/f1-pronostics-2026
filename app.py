...
CALENDRIER_2026 = {
    ...
    "Canada":      datetime(2026, 5, 24, 18, 0, tzinfo=timezone.utc),
    "Monaco":      datetime(2026, 6, 7, 13, 0, tzinfo=timezone.utc),
    "Barcelone":   datetime(2026, 6, 14, 13, 0, tzinfo=timezone.utc),
    "Autriche":    datetime(2026, 6, 28, 13, 0, tzinfo=timezone.utc),
    "Royaume-Uni": datetime(2026, 7, 5, 14, 0, tzinfo=timezone.utc),
    "Belgique":    datetime(2026, 7, 19, 13, 0, tzinfo=timezone.utc),
    "Hongrie":     datetime(2026, 7, 26, 13, 0, tzinfo=timezone.utc),
    "Pays-Bas":    datetime(2026, 8, 23, 13, 0, tzinfo=timezone.utc),
    ...
    "Brésil":      datetime(2026, 11, 8, 17, 0, tzinfo=timezone.utc),
...
# PRONOSTIC
COURSES_VERROUILLEES = ["Australie", "Chine", "Japon", "Miami", "Canada", "Monaco", "Barcelone", "Autriche", "Royaume-Uni"]
